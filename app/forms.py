...
from wtforms import BooleanField, HiddenField, PasswordField, SelectField, TextAreaField, TextField, validators
...
class CreateAlbumForm(Form):
    ...
    passwordProtected = BooleanField(u'Password Protected?')
    passwordHash = PasswordField(u'Album Password')
...
# TODO: Add a better mechanism for changing the password on an existing album. Maybe a "Change password" check box?
...
class AlbumAuthenticateForm(Form):
    password = PasswordField(u'Album Password')
